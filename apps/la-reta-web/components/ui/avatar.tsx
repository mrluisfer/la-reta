...
import { AVATAR_WIDTH, avatarSource } from "@/lib/photo";
...
const AvatarImage = ({
  ...
  /**
   * Ancho al que se pide la foto, en px. El default cubre los avatares de
   * hasta `size-10`, que son casi todos; los grandes (podio, tarjeta de MVP,
   * ficha flotante, ganador de casacas) pasan el suyo o salen borrosos.
   */
  ...
  return (
    <AvatarPrimitive.Image
      ...
      src={typeof src === "string" ? avatarSource(src, width) : src}
      className={cn(
